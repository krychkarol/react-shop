...
import { createSlide } from '../../Redux/api';
import { useDispatch } from 'react-redux';
import { Link, useNavigate } from 'react-router-dom';

const AdminCreateSlide = () => {
    ...
    const handleCreate = async (product) => {
        await createSlide(product, dispatch);
        navigate('/admin/slajder');
    };

    return (
        // SCSS => _adminProduct 
        <div className='admin-create-slider'>
        <div className='top'>
            <TitleBar title='Utwórz' subtitle='Nowy slajd'/>
        ...
        <div className='create'>
            <button onClick={() =>handleCreate(inputs)}>Utwórz slajd</button>
        </div>
    </div>
    );
};
